...
namespace RTLTMPro.Editor
{
    ...
    [CustomEditor(typeof(RTL_TMP_InputField), true)]
    public class RTL_TMP_InputFieldEditor : SelectableEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_foldout.fontSettings)
            {
                ...
                {
                    RTL_TMP_InputField inputField = target as RTL_TMP_InputField;
                ...
                if (!m_ContentType.hasMultipleDifferentValues)
                {
                    ...
                    if (m_ContentType.enumValueIndex == (int)RTL_TMP_InputField.ContentType.Standard ||
                        m_ContentType.enumValueIndex == (int)RTL_TMP_InputField.ContentType.Autocorrected ||
                        m_ContentType.enumValueIndex == (int)RTL_TMP_InputField.ContentType.Custom)
                    {
                        EditorGUI.BeginChangeCheck();
                        ...
                        if (EditorGUI.EndChangeCheck())
                        {
                            if (text != null)
                            {
                                if (m_LineType.enumValueIndex == (int)RTL_TMP_InputField.LineType.SingleLine)
                    ...
                    if (m_ContentType.enumValueIndex == (int)RTL_TMP_InputField.ContentType.Custom)
                    {
                        ...
                        if (m_CharacterValidation.enumValueIndex == (int)RTL_TMP_InputField.CharacterValidation.Regex)
                        {
                            EditorGUILayout.PropertyField(m_RegexValue);
                        }
                        else if (m_CharacterValidation.enumValueIndex == (int)RTL_TMP_InputField.CharacterValidation.CustomValidator)
                        {
