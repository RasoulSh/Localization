...
namespace RTLTMPro.Editor
{
    public class ContextMenu : UnityEditor.Editor
    {
        ...
        private static void CreateTextMeshProGuiObjectPerform(MenuCommand command)
        {
            ...
            // Create the LocalizeTmpText Object
            ...
            if (contextObject == null)
            {
                ...
                var textMeshPro = go.AddComponent<LocalizeTmpText>();
                textMeshPro.text = "";
        ...
        public static void CreateButton(MenuCommand command)
        {
            ...
            var textGo = new GameObject("Text", typeof(RectTransform), typeof(LocalizeTmpText));
            var goRectTransform = textGo.GetComponent<RectTransform>();
            var textMeshPro = textGo.GetComponent<LocalizeTmpText>();
